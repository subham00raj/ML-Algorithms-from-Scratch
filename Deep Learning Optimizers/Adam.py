...
class RMSprop:
    ...
    def fit(self, X_train, y_train):
        ...
        for epoch in range(self.epochs):
                ...
                # RMS prop updates
                self.velocity_coef_ = self.velocity_coef_ * self.momentum + (1- self.momentum) * dj_dw ** 2
                self.velocity_intercept_ = self.velocity_intercept_ * self.momentum + (1- self.momentum) * dj_db ** 2
